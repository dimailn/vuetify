...
The display state of `v-bottom-navigation` can be toggled using the **model-value** prop or **v-model**. You can also control the currently active button using **v-model**.
